...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // 2. Buscamos si existe la enfermedad y cuál es su foto actual
        ...
        if ($fila = mysqli_fetch_assoc($resultado)) {
            ...
            if ($stmt_update = mysqli_prepare($conexion, $sql_update)) {
                ...
                if (mysqli_stmt_execute($stmt_update)) {
                    ...
                    echo "<script>alert('Error al modificar en la base de datos.'); window.location.href='addEnfermedad.php';</script>";
                }
