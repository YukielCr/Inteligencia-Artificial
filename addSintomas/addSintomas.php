    ...
    <div class="container py-5">
        ...
        <div class="card shadow-lg border-0 rounded-4">
            <div class="card-body p-5">
                ...
                <h1 class="text-center mb-5 fw-bold text-primary">Sintomas</h1>
                    ...
                    <div class="row g-5">
                        ...
                        <div class="col-lg-7">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-lg" name="nombre" placeholder="Poner aqui los sintomas" required>
                            </div>
                            
                            <div class="mb-3">
                                <label class="form-label fw-bold">Descripción:</label>
                                <textarea class="form-control" name="descripcion" rows="4" placeholder="Ejemplo de los sintomas" required></textarea>
                            </div>
